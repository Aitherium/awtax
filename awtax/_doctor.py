...
interesting failures live BETWEEN them. "awtax is installed" is not the useful
fact -- "awtax is installed and the thing it pairs with is not" is. This reports
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awtax needs at runtime, and a
